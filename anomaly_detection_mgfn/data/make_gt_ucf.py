...
temporal_root = '/path/to/UCF_Crimes/Temporal_Anomaly_Annotation_For_Testing_Videos/Matlab_formate/'
...
for file in file_list:
    ...
    if count != num_frame:
        ...
        print(remainder)
        if remainder > 0 and remainder < 64:
            print('Fixing...')
            del gt[-remainder:]
            continue
