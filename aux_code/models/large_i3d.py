# Code taken from: https://github.com/Tushar-N/pytorch-resnet3d
import torch
...
############## Modified forward pass for different input and to extract features ##############
...
if __name__=='__main__':
    model = I3Res50(num_classes=102, use_nl=False)

    inp = torch.rand(5, 3, 16, 224, 224)
    output, features = model(inp)
